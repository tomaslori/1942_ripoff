...
public class LevelManager : MonoBehaviour {
	...
	private void initAircrafts () {
		...
		aircrafts.Add("F-22B",   new AircraftData (7.0f,  1, new GunsData (1.75f, 8.0f, 0.25f)));
		aircrafts.Add("F-35D",   new AircraftData (4.0f,  1, new GunsData (1.5f, 6.0f, 0.1f)));
		aircrafts.Add("FA-28A",  new AircraftData (5.5f,  2, new GunsData (2.5f, 6.5f, 0.2f)));
		aircrafts.Add("MiG-51",  new AircraftData (4.0f,  3, new GunsData (2.0f, 5.25f, 0.25f)));
		aircrafts.Add("MiG-51S", new AircraftData (4.0f,  1, new GunsData (5.0f, 5.25f, 0.25f)));
		aircrafts.Add("SR-91A",  new AircraftData (2.75f, 5, new GunsData (1.0f, 4.0f, 0.4f)));
	}
